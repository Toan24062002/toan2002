...
<body>
    ...
    <div class="login-container">
        <main>
        <h3>LOGIN</h3>
        <img src="{{asset ('public/icon/admin1.png')}}" alt="">
        <form action="{{route('home.kiemtradangnhap')}}" method="POST">
            @csrf
            ...
            <button type="submit" class="btn btn-primary" name="">Đăng nhập</button>
        </form>
        </main>
    </div>
